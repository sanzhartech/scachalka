...
internal static partial class StringCatalog
{
    public static IReadOnlyDictionary<string, string> Russian { get; } = new Dictionary<string, string>
    {
        ...
        [LocKeys.BtnImportLibrary] = "Импорт библиотеки Apple Music",
        [LocKeys.BtnImportLibraryTooltip] = "Выберите экспортированный songs.txt — каждая песня будет найдена и скачана автоматически",
